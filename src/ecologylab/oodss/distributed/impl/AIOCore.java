 ...
 * 
 */
public abstract class AIOCore extends Debug implements StartAndStoppable, NetworkingConstants
{
	 ...
	 */
	protected AIOCore(String networkingIdentifier, int portNumber) throws IOException
	{
