 ...
 */
public abstract class AIODatagramCore<S extends Scope> extends Debug implements NetworkingConstants
{
	 ...
	 */
	public AIODatagramCore(TranslationScope translationScope, S objectRegistry, boolean useCompression)
	{
	...
	public AIODatagramCore(TranslationScope translationScope, S objectRegistry)
	{
